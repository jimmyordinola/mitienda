...
function FormularioEdicion({ seccion, item, categorias, tiendas, productos = [], onGuardar, onCerrar }) {
  ...
  const campos = {
    ...
    tiendas: [
      ...
      { name: 'horario', label: 'Horario (texto visible)', type: 'text' },
      ...
      { name: 'serie_boleta', label: 'Serie Boleta Nubefact (ej: BBB1 prueba, B001 produccion)', type: 'text' },
      { name: 'serie_factura', label: 'Serie Factura Nubefact (ej: FFF1 prueba, F001 produccion)', type: 'text' },
      { name: 'disponible', label: 'Disponible', type: 'checkbox' },
    ],
  };
