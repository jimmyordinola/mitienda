        ...
        <form onSubmit={handleLogin}>
          ...
          <div className="relative my-3">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-2 bg-white text-gray-400">o continuar con</span>
            </div>
          </div>
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 py-2.5 px-3 bg-white border-2 border-gray-200 rounded-lg font-medium text-sm text-gray-700 hover:bg-gray-50 transition-all disabled:opacity-50 flex items-center justify-center gap-2"
            >
            ...
            <button
              ...
              disabled={socialLoading !== null}
              className="flex-1 py-2.5 px-3 bg-[#1877F2] text-white rounded-lg font-medium text-sm hover:bg-[#166FE5] transition-all disabled:opacity-50 flex items-center justify-center gap-2"
            >
