  ...
  return (
    <div className="bg-white rounded-2xl p-5 shadow-xl max-w-sm w-full">
      ...
      <button
        ...
        className="w-full py-2.5 bg-white border-2 border-gray-200 rounded-lg font-semibold text-sm text-[#3d2314] hover:bg-gray-50 transition-all flex items-center justify-center gap-2"
      >
